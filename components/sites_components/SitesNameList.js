...
export default function SitesNameList() {
    ...
    <>
      <div className="flex flex-col">
        <div className="flex justify-between items-center mb-4">
          <div className="flex flex-col">
            <h3 className="text-gray-900 text-[20px] font-semibold">Site</h3>
            <h6 className="text-[14px] text-gray-400">Domain Used in Sites</h6>
          </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-0 p-6 border border-gray-200 rounded-md justify-between items-center bg-white">
            <div className="grow flex items-center gap-3 justify-between pr-6">
              <div className="grow flex items-center gap-3">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <h6 className="text-[12px] text-gray-400">
                    Add a GIF to your confirmation page
                  </h6>
                </div>
              </div>

              <div>
                <h3 className="text-green-600 bg-green-100 text-[13px] capitalize py-[1px] px-2 rounded-full">
                  public
                </h3>
              </div>
            </div>
            <div className="ml-auto md:m-0 flex gap-8 items-center">
              <Switch
                checked={enabled}
                onChange={setEnabled}
                        ...
                        {({ active }) => (
                          ...
                          >
                            <div className="flex gap-2">
                              ...
                              <span className="text-[14px]">Embed</span>
                            </div>
                          </a>
                        )}
                      </Menu.Item>
          ...
          <div className="flex flex-col md:flex-row gap-3 md:gap-0 p-6 border border-gray-200 rounded-md justify-between items-center bg-white">
            <div className="grow flex items-center gap-3 justify-between pr-6">
              ...
              <div>
                <h3 className="text-red-600 bg-red-100 text-[13px] capitalize py-[1px] px-2 rounded-full">
                  private
                </h3>
              </div>
            </div>
