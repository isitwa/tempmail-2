...
export default function Team_Group() {
  return (
    <>
      <div className="flex flex-col gap-2">
        {/* email list */}
        <div className="flex flex-col md:flex-row gap-3 md:gap-0 p-6 border border-gray-200 justify-between items-center bg-white">
