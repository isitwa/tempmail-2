...
import SitesNameList from "../components/sites_components/SitesNameList";
    ...
    <>
      <div className="flex items-stretch ">
                        ...
                        >
                          <item.icon
                            className={classNames(
                              ...
                              "mr-4 flex-shrink-0 w-6 h-6 lg:h-4 lg:w-4"
                            )}
                            aria-hidden="true"
                          />
                          {item.name}
        ...
        <div className="flex flex-1 flex-col md:ml-[90px] lg:ml-56 px-0 md:px-8 lg:pl-11 w-full">
          ...
          <main className="flex-1 px-[15px] md:px-0">
            <div className="py-6">
              <div className="lg:flex gap-6">
                <div className="grow">
                  <SitesNameList />
                </div>
                <div className="flex flex-row lg:flex-col gap-1 lg:w-[250px] sticky top-0 border-l border-gray-200"></div>
              </div>
            </div>
          </main>
        </div>
