...
export default function AppTwo_Copy() {
  ...
  return (
    <>
      ...
      <div className="flex  h-[100vh] overflow-y-hidden ">
        <div className="w-full lg:w-[360px]  xl:w-[420px] shrink-0 justify-self-stretch">
          <div className="flex flex-col">
            <div className="flex justify-between items-center grow gap-5 p-3">
              <div className="">
                <Link
                  href="#"
                  className="text-black dark:text-white  font-bold text-[20px] "
                >
                  tempmail
                </Link>
              </div>
            ...
            <div className="grow  lg:hidden flex gap-4 justify-center border-b border-gray-300 dark:border-gray-300 mb-2 pb-2">
              <Link href="#" className=" group">
                <div className="flex flex-col  gap-2 relative align-middle items-center text-black dark:text-harry-50">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="w-5 h-5 text-center group-hover:text-gray-500"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                  ...
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    copy
                  </span>
                  <div className="group-hover:block hidden absolute py-[6px] px-4 rounded-xl bg-blue-600 -bottom-[50px] w-[120px] left-[50%] -translate-x-1/2">
                    ...
                    <h6 className="text-[13px] text-white">Copy email</h6>
                  </div>
                </div>
              </Link>
              <Link href="#" className=" group">
                <div className="flex flex-col  gap-2 relative align-middle items-center  text-black dark:text-harry-50">
                  <BiRefresh className="text-[21px] group-hover:text-gray-500" />
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    refresh
                  </span>
              ...
              <Link href="#" className=" group">
                <div className="flex  flex-col  gap-2 relative align-middle items-center  text-black dark:text-harry-50">
                  <GiPerspectiveDiceSixFacesRandom className="text-[21px] group-hover:text-gray-500" />
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    random
                  </span>
              ...
              <button className=" group" onClick={() => setOpen(true)}>
                <div className="flex  flex-col  gap-2 relative align-middle items-center  text-black dark:text-harry-50">
                  <MdPublishedWithChanges className="text-[21px] group-hover:text-gray-500" />
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    change
                  </span>
              ...
              <button className=" group" onClick={() => setOpen1(true)}>
                <div className="flex  flex-col  gap-2 relative align-middle items-center  text-black dark:text-harry-50">
                  <AiFillFastForward className="text-[21px] group-hover:text-gray-500" />
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    forwarding
                  </span>
              ...
              <Link href="#" className=" group">
                <div className="flex  flex-col  gap-2 relative align-middle items-center  text-black dark:text-harry-50">
                  <AiOutlineDelete className="text-[21px] group-hover:text-gray-500" />
                  <span className="text-[13px] 2xl:text-[16px] text-center group-hover:text-gray-500">
                    delete
                  </span>
            ...
            <div className="flex h-[86vh] flex-col ">
              ...
              <div className="my-auto w-full">
                <div className="flex flex-col gap-2">
                  <BsArrowClockwise className="text-zinc-400 dark:text-white text-[30px] mx-auto animate-spin" />
                  <h4 className="text-[16px] text-zinc-400 dark:text-white font-light text-center">
                    No messages
                  </h4>
                  <p className="text-[14px] text-zinc-400 dark:text-white font-light text-center">
        ...
        <div className="grow justify-self-stretch">
          <div className="flex flex-col h-full">
            <div className="flex h-full justify-self-stretch">
              <div className="grow">
                <div className=" hidden lg:flex flex-col pb-10 px-[15px] 2xl:px-[100px] dark:bg-zinc-800  bg-thor-700 border-r border-gray-300 dark:border-zinc-600 ">
                  {/* inner design */}
                  <div className="flex justify-between items-center py-5">
                    <div className="grow flex justify-center gap-8  border-b border-gray-300 dark:border-gray-300 mb-2 pb-2">
                      <Link href="#" className=" group">
           ...
           h-[100vh] overflow-y-hidden hover:overflow-y-auto pr-5  scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thin hover:scrollbar-thumb-gray-700 hover:scrollbar-track-gray-300"
                      ...
                      <div className="col-span-12">
                        <div className="flex flex-col">
                          ...
                          <p className="text-gray-500 dark:text-white text-[16px] text-center">
                            ...
                            protects your real email address from spam,
                            advertising mailings, malwares. It's anonymous and
                            free. This email has a limited lifetime period: if
                            this email will not receive messages due to some
                            time — it will be removed. Sometimes disposable
                            email is also called "
                            <strong>throwaway email</strong>", "
                            <strong>10 minute mail</strong>", "
                            <strong>tempmail</strong>
                            ", "<strong>trash mail</strong>" and "
                            <strong>fake mail</strong>". Temporary email can be
                            used for different websites (e.g. social networks),
                            download files from file hostings, use it each time
                            you want to stash your real email and paste
                            temporary email instead. For example, public Wi-Fi
                            spots, blogs and forums require users to complete
                            registration until they can fully use their website.
                          </p>
                        </div>
                      </div>
                    </div>
                            ...
                            <div className="flex flex-col border border-gray-200 rounded-md p-5 gap-1 group hover:drop-shadow-3xl ease-in bg-white">
                              ...
                              <div className="flex justify-between gap-4">
                                <div>
                                  ...
                                  >
                                    Consequat consequat sit ut ea minim elit
                                    incididunt irure
                                  </Link>
                                </div>
                                <div>
              ...
              <div className=" shrink-0 xl:w-[300px] w-[0px">
                <div className="flex items-center gap-4 justify-between p-3">
                  <Link
                    href="#"
                    className="text-[13px] xl:text-[14px] text-white bg-gray-600 hover:bg-gray-800 rounded-md py-[6px] px-[15px]"
                  >
                    <CiLogin className="text-[20px] md:hidden block" />
                    <span className=" hidden md:block">Login</span>
                  </Link>
                  <button
                    onClick={() => setOpen2(true)}
                    className="text-[13px] xl:text-[14px] text-white bg-blue-600 hover:bg-blue-800 rounded-md py-[6px] px-[15px]"
                  >
                    Premium
                  </button>
                  <div>
                ...
                <div className=" lg:w-[230px] xl:w-full w-[0px] h-[800px] p-2 overflow-hidden">
                  <Image
                    src={ads1}
                    alt="image"
                    className="w-full block lg:hidden xl:block"
                  />
                  <Image
                    src={ads1}
                    alt="image"
